...
import re
import six
import schema.unicorn_properties_local.publicationevaluationcompleted
    ...
    def unmarshall(cls, data, typeName):
        ...
        if type(typeName) == str:
            ...
            if typeName in cls.NATIVE_TYPES_MAPPING:
                ...
                typeName = getattr(schema.unicorn_properties_local.publicationevaluationcompleted, typeName)
