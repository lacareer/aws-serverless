...
class AuthPolicy(object):
    ...
    restApiId = "pq6e1uotni"
    """ Replace the placeholder value with a default API Gateway API id to be used in the policy(you can find it on the  console under your API and under the ID tab). 
